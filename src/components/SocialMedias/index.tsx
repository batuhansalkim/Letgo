...
const index = () => {
  return (
    ...
    <View style={{marginTop:"6%",marginBottom:"2%",borderWidth:1.2,borderColor:"#FF3E55",height:44,flexDirection:"row",borderRadius:22,justifyContent:"center",alignItems:"center",}}>
